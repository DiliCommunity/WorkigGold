...
Автоматически собирает заказы с бирж: FL.ru, Freelance.ru, Kwork, Habr Freelance, Guru. Агенты парсят объявления и присылают подходящие в этот чат.

*Возможности:*
• Парсинг заказов с 5 бирж
